...
function App() {
	return (
		<div className="min-h-screen bg-black text-white ">
			{/* Navigation */}
			<header className=" header sticky top-0 z-30 p-5 false ml-80 bg-black">
			...
			<div className="flex items-center justify-center">
				<img className="object-contain m-20" src={dashboard} alt="Dashboard" />
			</div>

			{/* Background Gradient Effect */}
			<div className="fixed inset-0 -z-10 bg-gradient-to-br from-purple-900/20 via-blue-900/20 to-rose-900/20" />
		</div>
	);
}
